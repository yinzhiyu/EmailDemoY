...
public class MailConstactsActivity extends Activity{
	...
	private void updateAddress(final String name,String address){
		...
		builder.setPositiveButton("确定", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				getContentResolver().update(uri, values, "mailfrom=? and name=?", new String[]{BaseApplication.info.getUserName(),name});
	...
	private void deleteAddress(final String name,String address){
		...
		builder.setPositiveButton("确定", new OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				getContentResolver().delete(uri, "mailfrom=? and name=?", new String[]{BaseApplication.info.getUserName(),name});
	...
	private List<EmailUsers> getAllConstacts(){
		...
		Cursor c=getContentResolver().query(uri, null, "mailfrom=?", new String[]{BaseApplication.info.getUserName()}, null);
		while(c.moveToNext()){
